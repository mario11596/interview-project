            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg m-5 w-1/2 p-6 space-y-4">
                <form method="POST" action="{{route('company.update_information', [$company->company_id])}}"
                    ...
                    @if(file_exists($photo))
                        <div class="mb-4">
                            ...
                            <img src="{{ asset('files/photos/'.Auth::user()->email.'.JPG') }}" width="150"
                                 height="150 "/>
                            <button type="submit" style="color:red" class="self-center">
                                <a href="{{ route('company.destroy_photo',Auth::user()->email) }}"
                                   onclick="return confirm('Jeste li sigurni da želite izbrisati fotografiju?');">
                    ...
                    <div class="flex justify-center">
                        ...
                        <x-jet-button type="button" onClick="history.go(-1);" class="hover:bg-red-delete">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
